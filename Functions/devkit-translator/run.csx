...
public static async Task<HttpResponseMessage> Run(HttpRequestMessage req, TraceWriter log)
{
    ...
    try
    {
        ...
        speechClient = new SpeechClient(subscriptionKey, req.Headers.GetValues("source").FirstOrDefault());
    }
    catch(Exception ex)
    {
    ...
    speechClient.OnEndOfTextData += (c, a) =>
    {
        ...
        textDecoder.Decode().ContinueWith(t =>
        {
            ...
            {
                var c2dTask = Task.Factory.StartNew(()=>serviceClient.SendAsync(deviceName, new Message(Encoding.ASCII.GetBytes(final.Translation))));
